...
function AddNewInterview() {
  ...
  const onSubmit = async (e) => {
    ...
    const InputPromt = `Generate ${process.env.NEXT_PUBLIC_INTERVIEW_QUESTION_COUNT} interview questions and answers in JSON format based on the following: Job Position: ${jobPosition}, Job Description: ${jobDesc}, Years of Experience: ${jobExperiance}. Only return the JSON, without any additional text.`;
